...
GST_PLUGINS_UGLY_CONF_ENV += CPPFLAGS="$(TARGET_CPPFLAGS) -D__DXDRM__ -I$(STAGING_DIR)/usr/include/dxdrm"
GST_PLUGINS_UIGLY_DEPENDENCIES += dxdrm
GST_PLUGINS_UGLY_LIBS += -lDxDrm
endif
else
